    ...
    <ThemeProvider theme={darkTheme}>
      ...
      {globalVariable === "zh-tw" ? (
        <>
          ...
          {isFiltered ? createDeviceCardTW(filteredData, filteredData) : createDeviceCardTW(dateData, dateData)}
        </>
      ) : globalVariable === "zh-cn" ? (
        <>
          {expanded && (
          ...
          {isFiltered ? createDeviceCardCN(filteredData, filteredData) : createDeviceCardCN(dateData, dateData)}
        </>
      ) : (
        <>
          {expanded && (
          ...
          {isFiltered ? createDeviceCardEN(filteredData, filteredData) : createDeviceCardEN(dateData, dateData)}
        </>
      )
      }
    </ThemeProvider >
